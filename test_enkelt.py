...
class TestEnkelt(unittest.TestCase):
	...
	def test_lexer(self):
		self.assertEqual(sample_code_for_testing_lexed, enkelt.lexer([line + '\n' for line in sample_code_for_testing.split('\n')[:-1]]))
