...
sample_code_for_testing_parsed = 'Enkelt.enkelt_print("Hej, Världen!")\nEnkelt.enkelt_print("Hej, Världen!")\n\nvar = 1\nvar_min = 2\n_variable = []\nmin_1_variabel = 75\nnum1 = {}\nlen("abc")\nlen([1, 2, "a", var ])\n\ninput = Enkelt.enkelt_input("Test")\n\nsystem("clear")\n\ntypen = type(4)\n\nkonv1 = str(20)+"3"\nkonv2 = Enkelt.enkelt_print(int("20")+3)\n\nEnkelt.enkelt_print(bool(0))\nEnkelt.enkelt_print(bool(1))\nEnkelt.enkelt_print(bool(""))\n\nEnkelt.enkelt_print(float("3.3")+3)\nEnkelt.enkelt_print(list("abc"))\n\nEnkelt.enkelt_print("hej".upper())\n\nEnkelt.enkelt_print(round(8.5673, 3))\n\nlista = ["a", "b"]\nEnkelt.enkelt_print(lista [0])\nlista.append("c")\nlista.insert(1, "c")\n\nannat = "".join(lista)\n\nwith open("enkelt.py", "r") as minFil:\n\tEnkelt.enkelt_print(minFil.read())\n\nvar = {"a":"alpha", "b":"beta", "namn":"Edvard"}\nEnkelt.enkelt_print(var ["a"])\nEnkelt.enkelt_print(var ["namn"])\n\nnum1 = 1+1\ntal2 = 2/2\ntal3 = 3% 3\nnum_2 = 4*4\n\nvar = True \nif var  == True:\n\tEnkelt.enkelt_print("Sant!")\nelif var  == False:\n\tEnkelt.enkelt_print("Falskt!")\nelse:\n\tEnkelt.enkelt_print("Vet ej!")\n\nnamn = "Kalle"\nEnkelt.enkelt_print("hej"+ namn)\n\nEnkelt.enkelt_print("Hej"+ namn if namn != "" else "Inget namn givet!")\n\nfor i in range(0, 11):\n\tEnkelt.enkelt_print(i)\n\tbreak \n\nfor sak in lista:\n\tEnkelt.enkelt_print(sak)\n\tcontinue \n\ndef min_funktion(a, b, c):\n\tEnkelt.enkelt_print(a + b)\n\n\treturn  c + a \n\nmin_funktion("a", "b", "c")\n\n\nclass Person:\n\tdef __init__(self, namn, ålder):\n\t\tself.namn = namn \n\t\tself.ålder = ålder \n\n\tdef åldra(self):\n\t\tself.ålder += 1\n\nperson1 = Person("Karl", 25)\nEnkelt.enkelt_print(person1.namn)\nperson1.åldra()\nEnkelt.enkelt_print(person1.ålder)\n\ntry:\n\ta = 1+2\nexcept Exception as fel:\n\tEnkelt.enkelt_print(fel)\nfinally:\n\tEnkelt.enkelt_print(4)\n\nmatte.abs(1)\n\nvar = lambda a, b: a + b \nEnkelt.enkelt_print(var(1, 2))\n\nEnkelt.enkelt_print("hej \\" Edvard| - ENKELT_ESCAPED_BACKSLASH -" ett annat tecken: \\\\ <-- där")\n'
